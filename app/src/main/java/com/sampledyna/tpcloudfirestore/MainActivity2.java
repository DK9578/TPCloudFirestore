        ...
        noteRef.set(contenuNote)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(MainActivity2.this, "Note entregistrée", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void deleteNote(View view){
        noteRef.update(KEY_NOTE, FieldValue.delete())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MainActivity2.this, "Erreur lors de la supression !", Toast.LENGTH_SHORT).show();
                        Log.d(TAG,e.toString());
                    }
                });
    }
